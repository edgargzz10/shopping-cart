...
function ready() {
  ...
  var botonesRestarCantidad =
    document.getElementsByClassName("restart-cantidad");
...
function agregarItemAlCarrito(titulo, precio, imagenSrc) {
    ...
    <div class="carrito-item">
        ...
        <div class="carrito-item-detalles">
            ...
            <div class="selector-cantidad">
                <i class="fa-solid fa-minus restart-cantidad"></i>
  ...
  //Agregamos la funcionalidad eliminar el nuevo item
  item
  ...
  var botonRestarCantidad = item.getElementsByClassName("restart-cantidad")[0];
